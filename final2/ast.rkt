...
;; tpye ExcMgr = (ExcMgr (Listof Handler) Expr)
(struct ExcMgr (exs e) #:prefab)

;; pr can be either an operator, variable, or lambda
;; type Handler = (Handler Expr Expr)
(struct Handler (pr ct) #:prefab)
