...
;; type Prog = (Prog (Listof Defn) (Listof Class) Expr)
(struct Prog (ds cs e) #:prefab)

;; type Defn = (Defn Id (Listof Id) Expr)
(struct Defn (f xs e) #:prefab)

;; type CField = (Pair Id Expr) 
(struct CField (v e) #:prefab)

;; type Class = (Class id (Listof id) (Listof Expr))
(struct Class (c xs fs) #:prefab)
